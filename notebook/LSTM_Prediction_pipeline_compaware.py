...
from LSTM_Database_writer2 import DatabaseWriter
    ...
    def run_pipeline(self,
        ...
        try:
            ...
            if success:
                ...
                # ALSO write to simple anomaly_detection_results table
                logger.info("Writing to simple anomaly_detection_results table...")
                self.db_writer.write_simple_results(results_df, if_exists='append')
